        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1" role="group" aria-label={locale === 'pt' ? 'Selecionar idioma' : 'Select language'}>
            <button
              ...
              className={`${locale === 'pt' ? 'bg-slate-900 text-white' : 'bg-white text-slate-900 border'} px-2.5 py-1.5 rounded-md text-sm hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-slate-900/30`}
            >PT</button>
            <button
              onClick={() => setLocale('en')}
              className={`${locale === 'en' ? 'bg-slate-900 text-white' : 'bg-white text-slate-900 border'} px-2.5 py-1.5 rounded-md text-sm hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-slate-900/30`}
            >EN</button>
          </div>
